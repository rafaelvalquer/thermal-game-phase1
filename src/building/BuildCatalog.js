export const BUILD_CATALOG = {
  ...
  airHandler: { label:'Air Handler', icon:'AH', cost:8000, inventory:1, kind:'entity', category:'HVAC', description:'Até 2,5 m³/s e 25 kW de resfriamento. Conecte insuflação, retorno e linha frigorífica às portas marcadas.' },
  condenser:  { label:'Condensadora', icon:'CD', cost:10000, inventory:1, kind:'entity', category:'HVAC', description:'Capacidade nominal de rejeição de 30 kW. Conecte à porta frigorífica do Air Handler.' },
  refrigerantLine:{label:'Linha frigorífica',icon:'║║',cost:95,inventory:60,kind:'utility',category:'HVAC',description:'Par isolado de linhas que conecta AHAir Handler e condensadora; pode atravessar paredes.'},
  ...
  returnVent: { label:'Vent retorno', icon:'↑', cost:160, inventory:4, kind:'entity', category:'HVAC', description:'Mede o ar de retorno e aspira o fluxo; a topologia classifica automaticamente o duto.' },
