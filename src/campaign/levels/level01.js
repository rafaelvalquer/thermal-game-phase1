...
export const level01={
  ...
  briefing:'Esta é a bancada inicial do Thermal Lab. Observe como o calor se acumula, teste airflow e monte um circuito de água. A física decide o resultado.',
  map:level01Map,environment:{outdoorTemperature:25},budget:50000,powerLimit:10000,missionDuration:300,
  inventory:{wall:50,insulation:20,copper:10,fan:4,exhaust:2,pipe:40,pump:1,tank:1,radiator:2,exchanger:3,sensor:5,demolish:Infinity},
  zones:[{id:'machine-room',name:'Sala de Máquinas',x:9,y:11,width:46,height:35,target:40}],
  entities:[
