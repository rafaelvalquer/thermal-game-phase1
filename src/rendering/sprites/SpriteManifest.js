...
const cooling = '/assets/sprites/cooling/';
...
export const SPRITES = Object.freeze({
  ...
  coolingUnit:definition('coolingUnit',cooling+'condenser.svg',3,{fps:4,visualScale:1.28,visualWidth:1.24,visualHeight:1.34,rotation:false}),
